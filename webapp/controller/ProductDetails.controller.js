sap.ui.define([
	"products/products/controller/BaseController.controller",
	...
	return BaseController.extend("products.products.controller.ProductDetails", {
		formatter: formatter,
		...
		getFormFields: function() {
			return [
				...
				//because of category and supplier doesn't work - they are not required fields
			]
		},
